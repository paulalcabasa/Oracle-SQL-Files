...
having nvl(entered_dr,0) - nvl(entered_cr,0) <> 0;
...
--                              glcc.segment6,
--                              gl_flexfields_pkg.get_description_sql(chart_of_accounts_id,2, segment6)) account_name,
