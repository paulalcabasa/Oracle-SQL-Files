...
SELECT distinct
        ...
        aaa.creation_date transaction_date,
        ...
        xah.period_name,
        aaa.doc_sequence_value adjustment_voucher_no,
--        ac.customer_number,
--        ac.customer_name,        
        gjh.je_source,
        xal.description,
...
FROM   
        ...
        LEFT JOIN apps.ar_adjustments_all aaa
            ON NVL (xte.source_id_int_1, -99) = aaa.adjustment_id
...
--            ON rcta.bill_to_customer_id = ac.customer_id
        LEFT JOIN fnd_user fu_trans
             ON fu_trans.user_id =aaa.created_by
