...
select   
            nvl(fu.description,fu.user_name) transacted_by,
            aca.creation_date transaction_date,
...
from 
       ...
       INNER  JOIN xla.xla_transaction_entities xte
        ...
        INNER JOIN ap_checks_all aca
            ON aca.check_id = NVL(xte.source_id_int_1,-99)
...
where 1 = 1
        ...
        AND gjh.doc_sequence_value = '83071792'
...
SELECT *
FROM GL_JE_HEADERS
WHERE DOC_SEQUENCE_VALUE = '83089276';
