...
select
         xdl.ae_header_id,    xdl.ae_line_num,    xah.je_category_name,    xah.accounting_entry_type_code,    xah.period_name,    xdl.accounting_line_code,    xah.gl_transfer_status_code,    xah.gl_transfer_date,    xah.description,    gcc.segment1,    gcc.segment2,    gcc.segment3,    gcc.segment4 ,    gcc.segment5,    gcc.segment6,    gcc.segment7,    gcc.segment8,    gcc.segment9,    xal.description ,    xal.entered_dr ,    xal.entered_cr,    xal.accounted_dr,    xal.accounted_cr
