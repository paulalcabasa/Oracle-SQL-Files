SELECT to_char(nvl(apsa.gl_date,aprha.gl_date),'DD/MM/YYYY') voucher_date,
            ...
            acra.receipt_number check_reference,
...
WHERE 1 = 1
            AND TO_DATE(aprha.gl_date) between  TO_DATE (:P_DATEFROM, 'yyyy/mm/dd hh24:mi:ss') and TO_DATE (:P_DATETO, 'yyyy/mm/dd hh24:mi:ss');
