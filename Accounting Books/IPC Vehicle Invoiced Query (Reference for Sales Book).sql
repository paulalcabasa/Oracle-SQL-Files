SELECT customer_name,
       ...
       SUM(tax) tax,
       so_num,
       MAX(purchase_order) purchase_order,
       MAX(dr_num) dr_num,
       inventory_item_id,
  ...
  FROM (SELECT hp.party_name customer_name,
                ...
                SUM (              
                        CASE
                            WHEN rcta.cust_trx_type_id = 1002 AND rctla.interface_line_attribute11 = 0 THEN rctla.line_recoverable
            ...
            FROM -- INVOICE
                 ...
                 LEFT JOIN ra_cust_trx_types_all rctta
