...
select *
from xla_events
where event_id = 1360466;

select *
from xla_transaction_entities_upg
where entity_id = 1332448;

select *
from mtl_material_transactions
where transaction_id = 2183930;

select *
from rcv_transcations;

select *
from rcv_transaction_headers_all;